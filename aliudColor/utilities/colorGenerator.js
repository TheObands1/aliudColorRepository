export const HSLNormalColor = () => {
   ...
   const h = Math.floor(Math.random() * (340 - 0) + 0);
   const s = Math.floor(Math.random() * (100 - 90) + 90);
 ...
 export const HSLDifferentColor = ({ h, s, l }) => {
   ...
   const newH = h + Math.floor(Math.random() * (20 - 15) + 15);
   const newS = s + Math.floor(Math.random() * (10 - 0) + 0);;
